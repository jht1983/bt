...
<body>
    ...
    <script type="text/javascript"
        src="<%=toolkitPath%>/report/handleReport.js"></script>
                  ...
                  <!--   <div class="col-sm-3">
                        <div class="row">
                            <div class="form-group">
                                <label class="searchLabel col-sm-4 control-label no-padding-right"
                                    for="inqu_status-scaleCode">班组</label>
                                <div class="col-sm-7 inputFrame">
                                    <input type="text" id="inqu_status-scaleCode" data-bxwidget class="searchInput" style="float:right ;margin-right:25%;"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="row">
                            <div class="form-group">
                                <label class="searchLabel col-sm-4 control-label no-padding-right"
                                    for="inqu_status-scaleName">班次</label>
                                <div class="col-sm-7 inputFrame">
                                    <input type="text" id="inqu_status-scaleName" data-bxwidget class="searchInput" style="float:right ;margin-right:25%;"/>
                                </div>
                            </div>
                        </div>
                    </div> -->
