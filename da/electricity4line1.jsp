...
<body>
	...
	<script type="text/javascript" src="<%=toolkitPath%>/da/electricity4line1.js"></script>
							...
							<div class="col-sm-12 col-xs-12 list"  id="queryarea">
								...
								<div class="col-sm-5 col-lg-4 col-xs-12 no-padding" >
									...
									<div class="col-sm-9 col-lg-9 col-xs-8 no-padding" >	
										<input id="inqu_status-startTime"class="Wdate inputFour timePicter" type="text" onfocus="startTime();"/>	
										<label id="label" class="labelFour control-label">至</label> 
										<input id="inqu_status-endTime" class="Wdate inputFour timePicter" type="text"  onfocus="endTime();"/>
									</div>
								</div>							
